...
gramatica = {'terminais': ['ε', '[', ',', '[^<>]+', '[0-9]+', ']'], 'nao_terminais': ['Resto', 'Elem', 'string', 'Lista', 'Cont', 'Elems', 'int'], 'producoes': {'Lista': [['[', 'Cont']], 'Cont': [[']'], ['Elems', ']']], 'Elems': [['Elem', 'Resto']], 'Resto': [['ε'], [',', 'Elem', 'Resto']], 'Elem': [['int'], ['string']], 'int': [['[0-9]+']], 'string': [['[^<>]+']]}, 'inicial': 'Lista', 'literais': {'[', ',', ']'}}
prox_simb = None
