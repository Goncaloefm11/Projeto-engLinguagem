...
gramatica = {'terminais': ['+', '.', '(', '[0-9]+', ')', '*', 'ε'], 'nao_terminais': ['Lista', 'Funcao', 'Exp', 'Lista_P', 'INT', 'Sexp'], 'producoes': {'Sexp': [['Exp', '.']], 'Funcao': [['+', 'Lista'], ['*', 'Lista']], 'Lista_P': [['Exp', 'Lista_P'], ['ε']], 'INT': [['[0-9]+']], 'Exp': [['INT'], ['(', 'Funcao', ')']], 'Lista': [['Lista_P']]}, 'inicial': 'Sexp', 'literais': set()}
prox_simb = None
